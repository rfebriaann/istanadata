                            ...
                            <table class="w-full text-md text-center text-gray-500 dark:text-gray-400">
                                ...
                                <tbody>
                                    ...
                                    <tr class="border-b dark:border-gray-200">
                                            ...
                                            <td class="px-4 py-3 text-blue-500"><span class="bg-[#0365FE]/20 text-sm leading-8 text-[#0365FE] font-medium p-1 rounded-2xl px-4">{{ucwords(strtolower($bidangurusan['kode_bidang']))}}</span></td>
