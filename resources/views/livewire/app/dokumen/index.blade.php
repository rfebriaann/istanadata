                                            ...
                                            <table class="w-full text-md text-center text-gray-500 dark:text-gray-400">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="border-b dark:border-gray-200">
                                                            ...
                                                            <td class="px-4 text-left py-3 text-blue-500"><span class="bg-[#0365FE]/20 text-sm leading-8 text-[#0365FE] font-medium p-1 rounded-2xl px-4">{{ucwords(strtolower($dokumen->nama_dokumen))}}</span></td>
                                                            <th scope="row" class="px-6 text-left py-2 font-medium text-gray-900">{{ucwords(strtolower($dokumen->deskripsi))}}</th>
                                                            <th scope="row" class="px-6 text-left py-2 font-medium text-gray-900">{{ucwords(strtolower($dokumen->tahun_dokumen))}}</th>
                                                            {{-- <th scope="row" class="px-6 text-left py-2 font-medium text-gray-900">{{ucwords(strtolower($dokumen->tgl_upload))}}</th> --}}
                                                            <th scope="row" class="px-6 text-left py-2 font-medium text-gray-900"><a href="{{route('dokumen.edit.{id}', $dokumen->id)}}">Edit ✏️</a> <button wire:click="destroy({{$dokumen->id}})">Hapus 🗑️</button></th>
                                                    </tr>
                                                    @endforeach
                                                </tbody>
                                            </table>
