                ...
                <div class="px-5 mt-16 lg:mt-20 lg:px-10">
                    <div class="relative max-w-screen-xl mx-auto">
                        ...
                        <div class="relative z-10 p-6 bg-white shadow-xl md:p-10 rounded-xl">
                            ...
                            <a 
                                        href="<?php echo e(route('tambah-gambar')); ?>"
                                            ...
                                            <table class="w-full text-md text-left text-gray-500 dark:text-gray-400">
                                                <thead class="text-xs text-gray-700 uppercase bg-gray-50">
                                                    <tr>
                                                        ...
                                                        <th scope="col" class="px-4 py-3">Tahun Dokumen</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="border-b dark:border-gray-200">
                                                            ...
                                                            <td class="px-4 py-3 text-blue-500"><span class="bg-[#0365FE]/20 text-sm leading-8 text-[#0365FE] font-medium p-1 rounded-2xl px-4"><?php echo e(ucwords(strtolower($gambar->nama_gambar))); ?></span></td>
                                                            <th scope="row" class="px-6 text-left py-2 font-medium text-gray-900"><?php echo e(ucwords(strtolower($gambar->deskripsi))); ?></th>
                                                            <th scope="row" class="px-6 text-left py-2 font-medium text-gray-900"><?php echo e(ucwords(strtolower($gambar->tahun_dokumen))); ?></th>
                                                            <th scope="row" class="px-6 text-left py-2 font-medium text-gray-900"><?php echo e(ucwords(strtolower($gambar->tgl_upload))); ?></th>
                                                    </tr>
...
<?php /**PATH /Users/raflifebrian/Documents/Dev/portaldata/resources/views/livewire/app/gambar/index.blade.php ENDPATH**/ ?>