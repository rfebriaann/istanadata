                        ...
                        <div class="overflow-x-auto">
                            <table class="w-full text-md text-center text-gray-500 dark:text-gray-400">
                                ...
                                <tbody>
                                    ...
                                    {{-- <embed src="{{asset('storage/assets/files/BUKU IHK 2022.pdf')}}" type="application/pdf" width="100%" height="600px" /> --}}
                                    <tr class="border-b dark:border-gray-200">
                                            <td class="px-4 py-3">{{$i++}}</td>
                                            <td class="px-4 text-left py-3 text-blue-500"><a href="{{asset('storage/assets/files/' . $dokumen->file_dokumen)}}"><span class="bg-[#0365FE]/20 text-sm leading-8 text-[#0365FE] font-medium p-1 rounded-2xl px-4">{{ucwords(strtolower($dokumen->nama_dokumen))}}</span></a></td>
                                            ...
                                            <th scope="row" class="px-6 text-left py-2 font-medium text-gray-900">{{ucwords(strtolower($dokumen->opd->uraian_skpd))}}</th>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
