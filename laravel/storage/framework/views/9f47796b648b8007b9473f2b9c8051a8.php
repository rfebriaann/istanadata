        ...
        <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
            <div>
                <p class="text-sm text-gray-700 leading-5">
                    ...
                    <!-- __BLOCK__ --><?php if($paginator->firstItem()): ?>
...
<?php endif; ?> <!-- __ENDBLOCK__ -->
<?php /**PATH /Users/raflifebrian/Documents/Dev/portaldata/vendor/laravel/framework/src/Illuminate/Pagination/resources/views/tailwind.blade.php ENDPATH**/ ?>