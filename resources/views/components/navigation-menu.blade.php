<section class="p-3 flex justify-center mt-0 fixed w-full px-0 left-0 z-10 top-0 mx-auto">
    <nav class="bg-[#0166FE] z-10 sm-l:bg-red-500 xl:px-2 mx-20 sm:w-[370px] sm:mx-auto lg:w-[900px] lg:mx-auto md:w-[730px] xl:w-[1280px] xl:mx-20 md:rounded-full border-2 sm:rounded-3xl shadow-lg">
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-default">
            <ul class="font-medium flex flex-col p-4 md:p-0 mt-4  rounded-lg md:flex-row md:space-x-8 md:mt-0 md:border-0 ">
                ...
                <button id="dropdownNavbarLink" data-dropdown-toggle="dropdownNavbar-desacantik" class="flex items-center justify-between w-full py-2 pl-3 pr-4 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 md:w-auto text-white md:dark:hover:text-blue-500 dark:focus:text-white">Desa Cantik <svg class="w-2.5 h-2.5 ml-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
                </svg></button>
                <div id="dropdownNavbar-desacantik" class="z-10 hidden font-normal bg-[#0255DB] divide-y divide-gray-100 rounded-lg shadow w-44">
