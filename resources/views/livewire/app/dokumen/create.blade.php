                                                        ...
                                                        <div class="grid grid-cols-1 gap-2 lg:grid-cols-2 lg:gap-10">
                                                            <div class="space-y-1">
                                                                <label 
                                                                    ...
                                                                    class="font-medium"
                                                                >
                                                                    Berkas Kegiatan PDF<span class="text-red-600">*</span>
                                                                </label>
                                                                <p class="text-sm">
                                                                        ...
                                                                        >
                                                                            <div class="flex text-black items-center w-full h-full space-x-2 cursor-pointer group">
                                                                                ...
                                                                                <span class="w-64 pr-2 truncate">
                                                                                    {{ $file ? $file->getClientOriginalName() : 'Pilih berkas' }}
                                                                                </span>
                                                                            </div>
                                                                        </div>
                                                                        <div 
                                                                    ...
                                                                    >
                                                                        ...
                                                                        >
                                                                            <div class="flex text-black items-center w-full h-full space-x-2 cursor-pointer group">
                                                                                ...
                                                                                <span class="w-64 pr-2 truncate">
                                                                                    {{ $csv ? $csv->getClientOriginalName() : 'Pilih berkas' }}
                                                                                </span>
                                                                            </div>
                                                                        </div>
                                                                        <div 
                                                        ...
                                                        <div class="grid grid-cols-1 gap-2 lg:grid-cols-2 lg:gap-10">
                                                            <div class="space-y-1">
                                                                <label 
                                                                    ...
                                                                    class="font-medium"
                                                                >
                                                                    Unggah Cover <span class="text-red-600">*</span>
                                                                </label>
                                                                <p class="text-sm">
                                                                    Unggah cover berkas berupa jpg
                                                                </p>
                                                            </div>
                                                            <div class="pt-0 lg:pt-3">
                                                                <div 
                                                                    ...
                                                                    >
                                                                        ...
                                                                        >
                                                                            <div class="flex text-black items-center w-full h-full space-x-2 cursor-pointer group">
                                                                                ...
                                                                                <span class="w-64 pr-2 truncate">
                                                                                    {{ $cover ? $cover->getClientOriginalName() : 'Pilih berkas' }}
                                                                                </span>
                                                                            </div>
                                                                        </div>
                                                                        <div 
