        ...
        <div class="h-[550px] sm:-mb-[40px] md:-mb-[70px] lg:mb-[70px] lg:w-full p-0 rounded-3xl mt-16 justify-items-stretch">
            <div class="grid gap-2 lg:grid-cols-2 sm:grid-cols-1  sm:mx-auto">
                <div class="h-48 mt-2 mb-8 lg:w-full col-span-2">
                    ...
                    {{-- <h5 class="lg:text-4xl mb-4 sm:text-5xl z-40 text-center text-[#181818] font-medium">Informasi dan Sistem Terpadu Analisis Data Kabupaten SIak</h5> --}}
                ...
                <div class="h-auto sm:flex lg:flex md:flex md:-mt-[100px] lg:mt-[2px] justify-center xl:-mt-[127px] w-full col-span-2">
                    <img class="z-1 h-[80%]" src="{{asset('assets/images/landingimage5.png')}}" alt="">
                </div>
            </div>
            <div class="w-full flex justify-center absolute sm:mx-auto inset-x-0  -mt-[20px] xl:-mt-[4px]">
                <div class="rounded-2xl sm:-mt-[60px] shadow-black-900 md:absolute md:bg-white sm:bg-slate-100 md:h-[150px] md:w-[500px] lg:w-[680px] xl:w-[800px] sm:h-[300px] sm:w-[380px] md:-mt-[120px] lg:-mt-[220px] xl:-mt-[350px] shadow-lg">
        ...
        <div class="bg-[#0166FE] z-20 h-auto w-full py-20 rounded-[40px] justify-items-stretch sm:mt-24 md:-mt-[10px]">
            ...
            <div class="flex justify-center sm:mx-1 md:mx-14">
                <div class="grid w-full gap-3 md:grid-cols-5 sm:grid-cols-1 sm:justify-center p-10 sm:-mt-[100px] md:-mt-10">
                    <div class="col-span-2 lg:flex justify-center lg:-mt-28 lg:-ml-10">
                    ...
                    @foreach ($dokumens as $dokumen)
                        <div class="bg-[#2678fc] rounded-2xl h-[140px] flex p-2 overflow-hidden justify-center col-span-1 duration-150 hover:scale-105">
                            <div class="grid sm:grid-cols-1 md:grid-cols-3 sm:-gap-4 md:gap-4 h-full w-full content-center items-stretch">
                                <div class="col-span-1 overflow-hidden h-full md:w-24 bg-center bg-cover">
                                    <img class="md:h-28 md:w-20 sm:h-10 sm:w-10 mx-auto rounded-lg" src="{{asset('storage/assets/files/' . $dokumen->cover_dokumen)}}" alt="">
                                </div>
                                <div class=" md:mx-30 sm:mx-2 mt-2 col-span-2 h-full relative">
                                        <span>
                                            ...
                                            <p class="md:text-md sm:text-xs sm:line-clamp-1 md:line-clamp-1 text-white font-thin">{{$dokumen->deskripsi}}</p>
                                        </span>
                                    <div class="flex mt-3 justify-start gap-2">
                                        @if ($dokumen->file_dokumen != null)
                                        <div>
                                            <a href="{{asset('storage/assets/files/' . $dokumen->file_dokumen)}}" target=”_blank”>
                                                <span class="px-3 py-1 bg-red-500 text-white rounded-md md:text-sm sm:text-[10px]">PDF</span>
                                            </a>
                                        </div>
                                        @endif

                                        @if ($dokumen->file_dokumen_csv != null)
                                        <div>
                                            <a href="{{asset('storage/assets/files/' . $dokumen->file_dokumen_csv)}}" target=”_blank”>
                                                <span class="px-3 py-1 bg-green-500 text-white rounded-md md:text-sm sm:text-[10px]">CSV</span>
                                            </a>
                                        </div>
                                        @endif
                                    </div>
                ...
                <div class="flex justify-center mx-14 py-10 mt-10 border-b sm:hidden">
                    <div class="grid w-full  gap-3 md:grid-cols-5 sm:grid-cols-1sm:justify-center p-10 -mt-10">
                        ...
                        <div class="col-span-2 justify-center -mt-28 ml-10">
                            <img class="h-[90%] mt-40" src="{{asset('assets/images/data.png')}}" alt="">
                        </div>
                    </div>
                </div>
