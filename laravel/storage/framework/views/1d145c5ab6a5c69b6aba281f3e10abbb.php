                                            ...
                                            <table class="w-full text-md text-center text-gray-500 dark:text-gray-400">
                                                <thead class="text-xs text-gray-700 uppercase bg-gray-50">
                                                    <tr>
                                                        ...
                                                        <th scope="col" class="px-4 py-3">Uraian SKPD</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="border-b dark:border-gray-200">
                                                            ...
                                                            <td class="px-4 text-left py-3 text-blue-500"><span class="bg-[#0365FE]/20 text-sm leading-8 text-[#0365FE] font-medium p-1 rounded-2xl px-4"><?php echo e(ucwords(strtolower($opd->kode_skpd))); ?></span></td>
...
<?php /**PATH /Users/raflifebrian/Documents/Dev/portaldata/resources/views/livewire/app/opd/index.blade.php ENDPATH**/ ?>