            ...
            <table id="myTable" class="table table-stripped">
                ...
                <tbody>
                    <?php
                        $i = 1;    
                    ?>
                    <?php $__currentLoopData = $dataSatuan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $filter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>    
                    <tr class="mt-28">
                        <td><?php echo e($i++); ?></td>
                        <td><?php echo e($filter->indikator); ?></td>
                        <td class="text-center"><?php echo e($filter->satuan); ?></td>
...
<?php /**PATH /Users/raflifebrian/Documents/Dev/portaldata/resources/views/test.blade.php ENDPATH**/ ?>