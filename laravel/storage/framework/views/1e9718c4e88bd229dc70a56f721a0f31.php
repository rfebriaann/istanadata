                                            ...
                                            <table class="w-full text-md text-center text-gray-500 dark:text-gray-400">
                                                ...
                                                <tbody>
                                                    <?php
                                                        $i = 1;
                                                    ?>
                                                    <!-- __BLOCK__ --><?php $__currentLoopData = $satuans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $satuan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr class="border-b dark:border-gray-200">
                                                            <td class="px-4 py-3"><?php echo e($i++); ?></td>
                                                            <th scope="row" class="px-6 text-left py-2 font-medium text-gray-900"><?php echo e(ucwords(strtolower($satuan->nama_satuan))); ?></th>
...
<?php /**PATH /Users/raflifebrian/Documents/Dev/portaldata/resources/views/livewire/app/satuan/index.blade.php ENDPATH**/ ?>