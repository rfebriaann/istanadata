                            ...
                            <table class="w-full text-md text-center text-gray-500 dark:text-gray-400">
                                ...
                                <tbody>
                                    <?php
                                        $i = 1;
                                    ?>
                                    <!-- __BLOCK__ --><?php $__currentLoopData = $indikators; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $indikator): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="border-b dark:border-gray-200">
                                            <td class="px-4 py-3"><?php echo e($i++); ?></td>
                                            <td class="px-4 py-3 text-blue-500"><span class="bg-[#0365FE]/20 text-sm leading-8 text-[#0365FE] font-medium p-1 rounded-2xl px-4"><?php echo e(ucwords(strtolower($indikator->kode_indikator))); ?></span></td>
                                            <th scope="row" class="px-6 text-left py-2 font-medium text-gray-900"><?php echo e(ucwords(strtolower($indikator->uraian_indikator))); ?></th>
                                            <th scope="row" class="px-6 text-left py-2 font-medium text-gray-900"><?php echo e(ucwords(strtolower($indikator->satuan->nama_satuan))); ?></th>
                                            <th scope="row" class="px-6 text-left py-2 font-medium text-gray-900"><?php echo e(ucwords(strtolower($indikator->bidangUrusan->bidang_urusan))); ?></th>
                                    </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> <!-- __ENDBLOCK__ -->
                                </tbody>
                            </table>
...
<?php /**PATH /Users/raflifebrian/Documents/Dev/portaldata/resources/views/livewire/guest/kegiatan/index.blade.php ENDPATH**/ ?>